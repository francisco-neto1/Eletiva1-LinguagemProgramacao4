...
<html lang="en">
  ...
  <form method="post" action="resultado.php">
    <div class="">
      ...
      <div class="col">
        <label from="valor3" class="label-control">Informe o valor: </label>
        <input type="number" name="valor3" id="valor3" class="form-control" />
      </div>
      <div class="col">
        <label from="valor4" class="label-control">Informe o valor: </label>
        <input type="number" name="valor4" id="valor4" class="form-control" />
      </div>
      <div class="col">
        <label from="valor5" class="label-control">Informe o valor: </label>
        <input type="number" name="valor5" id="valor5" class="form-control" />
      </div>
      <div class="col">
        <label from="valor6" class="label-control">Informe o valor: </label>
        <input type="number" name="valor6" id="valor6" class="form-control" />
      </div>
      <div class="col">
        <label from="valor7" class="label-control">Informe o valor: </label>
        <input type="number" name="valor7" id="valor7" class="form-control" />
      </div>
      <div class="col">
        <label from="valor8" class="label-control">Informe o valor: </label>
        <input type="number" name="valor8" id="valor8" class="form-control" />
      </div>
      <div class="col">
        <label from="valor9" class="label-control">Informe o valor: </label>
        <input type="number" name="valor9" id="valor9" class="form-control" />
      </div>
      <div class="col">
        <label from="valor10" class="label-control">Informe o valor: </label>
